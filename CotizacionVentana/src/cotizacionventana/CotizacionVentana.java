 ...
 * @author Chayito
 */
public class CotizacionVentana 
{
    ...
    public CotizacionVentana(int nC, String d, float p, float pPP, int pl, int dia, int m, int a)
    {
    ...
    public CotizacionVentana(CotizacionVentana otro)
    {
        //Constructor copia
